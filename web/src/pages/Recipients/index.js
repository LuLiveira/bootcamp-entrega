...
export default function Recipients() {
  ...
  async function handleDelete(id) {
    if (window.confirm('Deseja excluir o destinatário?') === true) {
      try {
      ...
      <BodyContent visible={loading}>
        ...
        <div className="table">
          <div className="line lineTitle">
            ...
            <div className="tabTitle">Endereço</div>
          ...
          {recipients.map(recip => (
            <div key={recip.id} className="line">
              <div className="tabTitle">#{recip.id}</div>
              <div className="tabTitle">{recip.name}</div>
