        ...
        <BodyContent visible={loading}>
          ...
          <div className="table">
            <div className="line lineTitle">
              <div className="tabTitle">Encomenda</div>
              <div className="tabTitle">Problema</div>
            ...
            {orderProblems.map(orderP => (
              <div key={orderP.id} className="line">
                <div className="tabTitle">#{orderP.delivery.id}</div>
                <div className="tabTitle">{orderP.shortDescription}</div>
