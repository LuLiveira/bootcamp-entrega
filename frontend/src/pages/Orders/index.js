        ...
        <BodyContent visible={loading}>
          ...
          <div className="table">
            <div className="line lineTitle">
              ...
              <div className="tabTitle">Destinatário</div>
              <div className="tabTitle">Entregador</div>
              <div className="tabTitle">Cidade</div>
              <div className="tabTitle">Estado</div>
            ...
            {orders.map(order => (
              <div key={order.id} className="line">
                <div className="tabTitle">#{order.id}</div>
